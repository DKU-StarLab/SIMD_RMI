...
for i, dataset in enumerate(datasets):
    ...
    ax.plot(linear_data['size_in_MiB'], (linear_welford_data['lookup_time']/linear_welford_data['n_samples'])/(linear_data['lookup_time']/linear_data['n_samples']), alpha=0.7, marker='o', color="orange")
...
# PDF 파일로 저장
plt.savefig(output_dir + 'simd_lookup_rel.svg')