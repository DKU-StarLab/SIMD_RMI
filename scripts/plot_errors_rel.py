...
file_path = "/home/test/SIMD_RMI/RMI_SIMD/results/rmi_errors.csv"
...
for idx, dataset in enumerate(datasets):
    ...
    data3 = data2['mean_ae']/data1['mean_ae']

    if not data3.empty:
        ax.plot(data2['size_in_MiB'], data3, marker='o', color='green')
...
# PDF 파일로 저장
plt.savefig(output_dir + 'simd_error_rel.svg')